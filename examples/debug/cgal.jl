...
soffitto_box1 = Common.add_zeta_coordinates(V,5.)
...
lato3_box1 = Common.apply_matrix(Common.t(0,5,0), lato1_box1)
...
lato4_box1 = Common.apply_matrix(Common.t(5,0,0), lato2_box1)
...
pavimento_box2 = Common.apply_matrix(Common.t(10,0,0),Common.add_zeta_coordinates(V,0.))
...
soffitto_box2 = Common.apply_matrix(Common.t(10,0,0),Common.add_zeta_coordinates(V,5.))
...
lato1_box2 = Common.apply_matrix(Common.t(10,0,0),Common.apply_matrix(Common.r(pi/2,0,0), lato_box2))
...
lato2_box2 = Common.apply_matrix(Common.t(10,0,0),Common.apply_matrix(Common.r(0,0,pi/2)*Common.r(pi/2,0,0), lato_box2))
...
lato3_box2 = Common.apply_matrix(Common.t(10,0,0),Common.apply_matrix(Common.t(0,5,0)*Common.r(pi/2,0,0), lato_box2))
...
lato4_box2 = Common.apply_matrix(Common.t(10,0,0),Common.apply_matrix(Common.t(5,0,0)*Common.r(0,0,pi/2)*Common.r(pi/2,0,0), lato_box2))
...
using FileManager
# 
# FileManager.save_pointcloud(raw"C:\Users\marte\Documents\GEOWEB\PROGETTI\BASIC\boxes_translate.las",PC,"test")
#
# Detection.save_plane_segments_in_ply(hyperplanes, raw"C:\Users\marte\Documents\GEOWEB\PROGETTI\BASIC\boxes_translate\SEGMENTS\prova.ply")
